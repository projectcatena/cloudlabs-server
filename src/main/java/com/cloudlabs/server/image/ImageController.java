...
public class ImageController {
    ...
    @PostMapping("/start")
    public BuildImageDTO startVirtualDiskBuild(@RequestBody ImageDTO image) throws InterruptedException, ExecutionException, IOException {
        
        BuildImageDTO response = imageService.startVirtualDiskBuild(image.getObjectName(), image.getImageName());
    ...
    @PostMapping("/cancel")
    public BuildImageDTO cancelVirtualDiskBuild(@RequestBody BuildImageDTO image) throws IOException {
    ...
    @PostMapping("/delete")
    public DeleteImageDTO deleteImage(@RequestBody ImageDTO image) throws IOException, InterruptedException, ExecutionException {
