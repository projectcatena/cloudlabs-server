...
public class ComputeServiceImpl implements ComputeService {
    ...
    /*
     * Create instance with an additional AttachedDisk parameter, which allows a
     * disk to be specified. This allows the user to revert to a previously saved
     * disk, or so called snapshot.
     */
    @Override
    public ComputeDTO createPublicInstance(ComputeDTO computeInstanceMetadata,
            AttachedDisk disk) {
